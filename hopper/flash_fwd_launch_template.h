...
template<typename Kernel_traits, bool Is_causal, bool Is_local, typename Seqlen_traits = flash::FixedSeqLenTraits, typename Seqlen_traits_Q = Seqlen_traits>
void run_flash_fwd(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    typename CollectiveMainloop::Params mainloop_params =
        CollectiveMainloop::to_underlying_arguments({
            ...
            seqlen_traits_k.get_gmem_layout(
                params.seqlen_k, params.d_v, params.h_k, params.b_k, 
    ...
    typename CollectiveEpilogue::Params epilogue_params = [&] {
        if constexpr(!Is_split) {
            return CollectiveEpilogue::to_underlying_arguments({            
                ...
                seqlen_traits_q.get_gmem_layout(
                    params.seqlen_q, params.d_v, params.h_k, params.b, params.h_h_k_ratio, 
...
template<typename T>
void run_mha_fwd_kvcache_hdim192(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    BOOL_SWITCH(params.is_causal, Is_causal, [&] {
        BOOL_SWITCH(params.is_local, Is_local, [&] {
            BOOL_SWITCH(params.num_splits > 1, Is_split, [&] {
                run_flash_fwd<
                    Flash_fwd_kernel_traits<Headdim, 128, 128, 12, 2, false, 1, T, Is_split, 1, HeaddimV>,
