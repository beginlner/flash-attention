    ...
    ext_modules.append(
        CUDAExtension(
            ...
            sources=[
                ...
                "csrc/flash_attn/src/flash_fwd_hdim320_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_hdim320_bf16_sm80.cu",
                ...
                "csrc/flash_attn/src/flash_bwd_hdim320_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim320_bf16_sm80.cu",
                ...
                "csrc/flash_attn/src/flash_fwd_split_hdim320_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim320_bf16_sm80.cu",
            ...
            extra_compile_args={
                "cxx": ["-O3", "-std=c++17", "-DNDEBUG", "-Wno-deprecated-declarations"] + generator_flag + fast_build_flag,
