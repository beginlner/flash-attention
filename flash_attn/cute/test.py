...
from interface import flash_attn_varlen_func
...
def test_flash_attention(b, mean_sq, mean_sk, varlen, h, h_k, d, dv, causal, window, has_bwd):
    ...
    def flash_attn():
        ...
        return flash_attn_varlen_func(q1, k1, v1, cu_seqlens_q, cu_seqlens_k, max_seqlen_q=max_seqlen_q, softmax_scale=softmax_scale, **kwargs)
